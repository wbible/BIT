...
public class OptionLabel extends JLabel implements MouseListener {
	...
	private Font font_num = new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 25);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(lb.getText().equals("≥Î∆Æ")) {
			
		}else if(lb.getText().equals("»˘∆Æ")) {
			
		}else if(lb.getText().equals("Ω««‡√Îº“")) {
			
		}else if(lb.getText().equals("¡ˆøÏ±‚")) {
			sudoku.setNumber("");
